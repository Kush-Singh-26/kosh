...
func TestAcquireBuildLock_Success(t *testing.T) {
	...
	if lock == nil {
		t.Fatal("AcquireBuildLock should return non-nil lock")
	}

	if lock.file == nil {
		t.Error("Lock should have file handle")
	}
	...
	t.Log("AcquireBuildLock success test passed")
}
...
func TestAcquireBuildLock_DoubleLockFails(t *testing.T) {
	...
	if err == nil {
		t.Error("Second AcquireBuildLock should fail when lock is held")
	}
