...
func TestExtractStringFromMap(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := ExtractStringFromMap(tt.m, tt.key)
			if result != tt.expected {
				t.Errorf("ExtractStringFromMap() = %q, want %q", result, tt.expected)
			}
		})
	}
}
...
func TestExtractSliceFromMap(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := ExtractSliceFromMap(tt.m, tt.key)

			if len(result) != len(tt.expected) {
				t.Errorf("ExtractSliceFromMap() length = %d, want %d", len(result), len(tt.expected))
				return
			}

			for i, v := range result {
				if v != tt.expected[i] {
					t.Errorf("ExtractSliceFromMap()[%d] = %q, want %q", i, v, tt.expected[i])
				}
			}
		})
	}
...
func TestExtractBoolFromMap(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := ExtractBoolFromMap(tt.m, tt.key)
			if result != tt.expected {
				t.Errorf("ExtractBoolFromMap() = %v, want %v", result, tt.expected)
			}
		})
	}
}
